 ...
 * @param data 颜色json
 */
exports.parseColorAttributes = function (color) {
 ...
 * @param blue 蓝
 */
function _transformColor(alpha, red, green, blue) {
 ...
 */
function _transformSingleColor(singleColor) {
    var tens = Math.floor(singleColor / 16);
    var digits = singleColor % 16;
